...
<html>
	 ...
	 <br><br><br><br><br><br><br>
                 ...
                 <h1><center>Découvrez nos musées selon la région où vous allez !</center>
				</h1>
<br>

                     <h2><center> les Musées en Bourgogne Franche-Comté</center></h2><br><hr>
 

             <div id="text">
                     <h3><center>  Destiné à tous, le site Musées de Bourgogne a pour but de vous faire connaître les établissement muséaux de la région.</center></h3>
		     </div>
                 ...
                 <center>
                     <table>
                         <tr>
                             <td><img SRC="image/b1.png" width="200"  height ="350"></td>
                             <td><img SRC="image/b2.png" width="200"  height ="350"></td>
                		 </tr>
				     </table>		
				 </center>
<br>
                 <center>
                     <table>
                         <tr>
                             <td><img SRC="image/b3.png" width="200"  height ="350"></td>
                             <td><img SRC="image/b4.png" width="200"  height ="350"></td>
                         </tr>
                     </table>
                 </center>
