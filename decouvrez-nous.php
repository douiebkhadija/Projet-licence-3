<html>
	 ...
	 <br><br><br><br><br><br><br>
         ...
         <link rel="stylesheet" href="style/decouvrez-nous.css" type="text/css" media="screen" />
	
	         <center> 
	             <div id="db">
				 
	                 <h2>Musée de France :</h2>
	                 <h4>Lors d’une visite au musée, il y a deux types de personnes :</h4>
					 <h4> ceux qui subissent et les passionnés. Toutefois, certains musées parviennent à mettre tout le monde d’accord. 
	                     Ils sont des témoignages de culture, d’art ou encore d’histoire, ils nous impressionnent,
	                     ils sont sur la liste des choses à visiter de milliers de touristes ; les musées sont des petits mondes à part où il fait bon se cultiver, regarder, admirer et se questionner. </h4>
	                   <h4> L'objectif de notre site est faciliter la recherche des musées selon la région où vous allez.</h4>
	                 <h4>Pour plus d'informations, vous pouvez nous contacter :</h4>
	                 <p>Email : musée.france@gmail.com</p>
	                 <p>Téléphone : 06.99.45.80.03</p>
		         </div>				
	         </center> 
