...
<br>
			     <h2><center> les Musées en iLE-DE-France </center></h2> 
<hr><br><br>

             <div id="text">
                 <h3><center>Du plus classique au plus original, la région parisienne regorge de musées à découvrir.<br>Vivez un moment de divertissement et de culture seul, entre amis ou en famille. </center></h3>
			 </div>
...
<br><br><hr><br><br><br>
                 ...
                 <center>
                     <table>
                         <tr>
                             <td><img SRC="image/i1.png" width="200"  height ="350"></td>
                             <td><img SRC="image/i2.png" width="200"  height ="350"></td>
                         </tr>
				     </table>
			     </center>
<br>
                 <center>
                     <table>
                         <tr>
                             <td><img SRC="image/i3.png" width="200"  height ="350"></td>
                             <td><img SRC="image/i4.png" width="200"  height ="350"></td>
                         </tr>
                     </table>
                 </center>
...
<br><hr><br><br><br>
                     ...
                     <p><center>les musées d'archéologie || les musées d'art || les Musée des Beaux-Arts || les musées des arts décoratifs || les musées d'histoire || les musées de sciences || musées d'histoire naturelle || les musées des techniques |
                         les musées d'ethnologie.</center> </p></center>
